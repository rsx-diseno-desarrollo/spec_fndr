...
if (inputBuscar.dataset.loaded) return;
inputBuscar.dataset.loaded = "true";
...
btnAddEditParte?.addEventListener("click", () => {
  ...
  // ELIMINAR PARTES
  // =========================
  containerPartes?.addEventListener("click", (e) => {
...
containerEditPartes?.addEventListener("click", (e) => {
